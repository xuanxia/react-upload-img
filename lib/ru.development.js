        ...
        _this.beforeUpload = function (file, fileList) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                img.onload = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
                    var width, height, showError, signData;
                            ...
                            switch (_context.prev = _context.next) {
                                case 0:
                                    ...
                                    showError = function showError() {
                                        _message2.default.error('\u60A8\u4E0A\u4F20\u7684\u56FE\u7247\u5C3A\u5BF8(' + width + ' * ' + height + ') \u4E0E\u8981\u6C42\u4E0D\u7B26 \u8BF7\u91CD\u65B0\u4E0A\u4F20');
                                        reject();
                                    };
                                ...
                                case 18:
                                    _context.next = 20;
                                    return getSign(suffixMap[file.type], width, height, extraParam);
